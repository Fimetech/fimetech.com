      ...
      <div className='mx-auto max-w-[var(--content-width)] px-6'>
        ...
        <RevealOnScroll direction='right' delay={0.2}>
          <div className='relative mt-12 md:ml-[5%] md:mr-[-5%]'>
            <div className='glass glass-glow overflow-hidden rounded-2xl'>
              ...
              <div className='relative aspect-video bg-gradient-to-br from-bg-surface to-bg-void'>
                ...
                <div className='absolute inset-0 flex items-center justify-center'>
                  <div className='grid grid-cols-8 gap-2 opacity-20'>
                    {Array.from({ length: 64 }).map((_, i) => (
                      <div
                        key={i}
                        className='h-4 w-4 rounded-sm bg-green-500'
                        style={{
                          // Deterministic pseudo-random opacity based on index
                          opacity: ((i * 7 + 3) % 10) / 20 + 0.2,
                ...
                <div className='absolute inset-x-0 bottom-0 p-6 md:p-8'>
                  <span className='mb-2 inline-block rounded-full border border-green-500/30 bg-green-500/10 px-3 py-1 font-[family-name:var(--font-jetbrains-mono)] text-xs text-green-400'>
                    Featured Project
                  </span>
            ...
            {/* Decorative elements */}
            <div className='absolute -right-4 -top-4 h-32 w-32 rounded-full bg-green-500/10 blur-3xl' />
            <div className='absolute -bottom-4 -left-4 h-24 w-24 rounded-full bg-green-400/10 blur-3xl' />
          </div>
        </RevealOnScroll>
